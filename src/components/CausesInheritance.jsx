    ...
    return (
        <section id={id} className="py-12 md:py-20 px-4 md:px-6 bg-white">
            <div className="max-w-4xl mx-auto">
                <h2 className="text-2xl md:text-4xl font-bold text-gray-900 mb-6 md:mb-10 text-center">Causes</h2>
                    ...
                    <div className="bg-blue-50 p-4 md:p-6 rounded-lg border-l-4 border-medical-blue">
                        ...
                        <div className="space-y-3">
                            ...
                            <ul className="list-disc list-outside space-y-2 text-gray-700 ml-5 pl-2">
                                ...
                                <li>These heterodimers (proteins with two polypeptide chains) assemble into long microtubule polymers that provide structural support.</li>
                    ...
                    <div className="bg-blue-50 p-6 rounded-lg border-l-4 border-medical-blue">
                        ...
                        <div className="space-y-4">
                            ...
                            <div>
                                ...
                                <p className="text-sm md:text-base text-gray-700 leading-relaxed">
                                    The majority of tubulinopathy cases (approximately 80-90%) result from <strong>de novo (new) mutations</strong>—mutations that occur spontaneously in the sperm, egg, or early embryo. These mutations are not inherited from either parent and typically occur for the first time in the affected individual.
                                </p>
                            </div>
                            <div>
